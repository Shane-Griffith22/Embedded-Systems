...
//PUPD Register
#define GPIOD_PIN8_PU	GPIOD->PUPDR |= (1 << 16)
#define GPIOD_PIN9_PU	GPIOD->PUPDR |= (1 << 18)
#define GPIOD_PIN10_PU	GPIOD->PUPDR |= (1 << 20)
#define GPIOD_PIN11_PU	GPIOD->PUPDR |= (1 << 22)
...
#define GPIOD_PIN0_OUT  GPIOD->MODER |= (1 << 0)
#define GPIOD_PIN1_OUT  GPIOD->MODER |= (1 << 2)
#define GPIOD_PIN2_OUT  GPIOD->MODER |= (1 << 4)
#define GPIOD_PIN3_OUT  GPIOD->MODER |= (1 << 6)
...
#define GPIOA_PIN0_IN 	GPIOA->MODER &= ~(0x3 << 0)
#define GPIOD_PIN8_IN	GPIOD->MODER &= ~(0x3 << 16)
#define GPIOD_PIN9_IN	GPIOD->MODER &= ~(0x3 << 18)
#define GPIOD_PIN10_IN	GPIOD->MODER &= ~(0x3 << 20)
#define GPIOD_PIN11_IN	GPIOD->MODER &= ~(0x3 << 22)
